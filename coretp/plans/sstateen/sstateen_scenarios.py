...
def SID_SMSTATEEN_006():
    ...
    write_m = CsrWrite(csr_name='mstateen0', value=0xDE00000000000001)
    ...
    check_val = LoadImmediateStep(imm=0xDE00000000000001)
    result_masked = Arithmetic(op="and", src1=result, src2=check_val)
    assert_equal = AssertEqual(src1=result_masked, src2=check_val)
...
def SID_SMSTATEEN_007_008():
    ...
    write_m = CsrWrite(csr_name='mstateen0', value=0x21FFFFFFFFFFFFFE)
